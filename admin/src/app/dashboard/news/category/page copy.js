...
import NewsDialogCategory from "@/components/news/NewdialogCategory";
      ...
      <div className="flex flex-col items-start justify-between gap-10 px-5 mt-10 md:flex-row">
        <div className="flex flex-col items-start justify-start w-full p-8">
          ...
          {allproductCategory && (
            <Sortable
              tag="ul"
              onChange={(order) => handleSort(order)} // This runs every time the user drags and reorders the items
            >
              {allproductCategory.map((item) => {
                const newitem = {
                  id: item._id,
                ...
                return (
                  <li
                    key={item._id}
                    data-id={item._id} // Required for SortableJS to identify each item
                    className="border border-b border-gray-200"
                  >
                    <div className="px-4 py-3 sm:px-6">
                      <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-start">
            ...
            >
              ...
              <p className="mb-6 text-sm text-gray-600" Name>
                this news category will be associated to your product when
                created.
              </p>
