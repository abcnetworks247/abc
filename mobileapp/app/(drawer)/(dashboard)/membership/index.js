  ...
  return (
    <SafeAreaView style={globalStyels.droidSafeArea}>
     ...
     {Plans.map(({price,name, description, features})=>{
        ...
        <View className="border-blue-600 rounded-2xl border  divide-gray-200  mt-10 w-full">
      <View className="">
        <View className="p-6">
          ...
          <Text className="mt-9">
            <Text className="text-2xl font-bold tracking-tight text-gray-900">${price}</Text>
            <Text className="text-base font-medium text-gray-500">/mo</Text>
          </Text>
          <TouchableOpacity
           
            className="flex justify-center text-center w-full py-3 mt-4 text-sm font-medium text-white bg-indigo-600 border border-indigo-600 rounded active:text-indigo-500 hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring"
          >
        ...
        <View className="px-6 pt-6 pb-8">
          ...
          <View className="flex space-x-3 flex-row mt-3">
    ...
    >
      ...
      <Text className="text-sm text-gray-500">{features}</Text>
    </View>
            )
          })}
        </View>
