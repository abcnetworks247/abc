  ...
  return (
	...
	<View className="container p-3 space-y-8">
		<View className="space-y-2 text-center">
			<Text className="text-3xl font-bold">Partem reprimique an pro type</Text>
		...
		<View className=" grid grid-cols-1 gap-y-8 ">
			<View className="flex flex-col ">
					<Image alt="" className="object-cover w-full h-52 object-top rounded-t" source={{uri: images.image1}} resizeMode='contain' resizeMethod='resize' />
			...
			<View className="flex flex-col ">
					<Image alt="" className="object-cover w-full h-52  object-top rounded-t" source={{uri: images.image2}} resizeMode='contain' />
				<View className="flex flex-col flex-1 p-1">
					<Link rel="noopener noreferrer" href="#" className="text-xs tracki uppercase hover:underline dark:text-default-400">Convenire</Link>
			...
			<View className="flex flex-col ">
					<Image alt="" className="object-cover object-top w-full h-52 rounded-t" source={{uri: images.image3}} resizeMode='contain' />
				<View className="flex flex-col flex-1 p-1">
					<Link rel="noopener noreferrer" href="#" className="text-xs tracki uppercase hover:underline dark:text-default-400">Convenire</Link>
					<Text className="flex-1 py-2 text-lg font-semibold leadi">Te nulla oportere reprimique his dolorum</Text>
					<View className="flex flex-wrap justify-between pt-3 text-xs ">
			...
			<View className="flex flex-col ">
					<Image alt="" className="object-cover w-full h-52 object-top rounded-t" source={{uri: images.image4}} resizeMode='contain' />
				<View className="flex flex-col flex-1 p-1">
					<Link rel="noopener noreferrer" href="#" className="text-xs tracki uppercase hover:underline dark:text-default-400">Convenire</Link>
					<Text className="flex-1 py-2 text-lg font-semibold leadi">Te nulla oportere reprimique his dolorum</Text>
					<View className="flex flex-wrap justify-between pt-3 text-xs ">
