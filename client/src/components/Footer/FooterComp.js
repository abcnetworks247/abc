    ...
    <div className="flex flex-wrap text-left lg:text-left">
      <div className="w-full lg:w-6/12 px-4">
        ...
        <div className="mt-6 lg:mb-0 mb-6 flex flex-wrap">
            <FaSquareFacebook  className=" text-lightBlue-600 shadow-lg font-normal text-2xl items-center justify-center align-center outline-none focus:outline-none mr-2"/>
            <FaSquareXTwitter className=" text-lightBlue-600 shadow-lg font-normal text-2xl items-center justify-center align-center outline-none focus:outline-none mr-2" />
            <FaSquareInstagram  className=" text-lightBlue-600 shadow-lg font-normal text-2xl items-center justify-center align-center outline-none focus:outline-none mr-2"/>
            <IoLogoYoutube className=" text-lightBlue-600 shadow-lg font-normal text-2xl items-center justify-center align-center outline-none focus:outline-none mr-2"/>
