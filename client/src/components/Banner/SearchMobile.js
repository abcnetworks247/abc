...
const SearchMobile = () => {
  ...
  return (
    <form className="sm:hidden" onClick={() => router.push("/searchproduct")}>
      <label
        for="default-search"
      ...
      <div className="relative">
        ...
        <input
          type="search"
          id="default-search"
          className="block focus:outline-none w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 
          rounded-lg bg-gray-50 focus: dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
