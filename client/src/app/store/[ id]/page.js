                    ...
                    <div className="mb-4 mr-4 lg:mb-0">
                      <div className="w-28 ">
                        ...
                        <div className="flex items-center border-gray-100">
                          <span
                            className="cursor-pointer rounded-l bg-gray-300 py-1 px-3.5 duration-100 hover:bg-gray-500 hover:text-blue-50"
                          ...
                          <span
                            className="cursor-pointer rounded-r bg-gray-300 py-1 px-3 duration-100 hover:bg-gray-500 hover:text-blue-50"
